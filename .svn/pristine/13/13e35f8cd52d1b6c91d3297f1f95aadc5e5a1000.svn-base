...
abstract class Paginator implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable
{
     ...
     * 插入操作动作
     */
    public function itemsDo()
    {
        $arr = $this->items->all();
        foreach ($arr as $k=>$v) {
            $arr[$k]['do'] = "<a href='".url('edit',['id'=>$v['id']])."' class='layui-btn  layui-btn-sm layui-btn-warm'>编辑</a>
                             <a href='".url('del',['id'=>$v['id']])."' class='layui-btn  layui-btn-sm layui-btn-danger js-ajax-delete'>删除</a>";
        }
        return $arr;
    }
